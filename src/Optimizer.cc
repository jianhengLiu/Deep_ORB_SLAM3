        ...
        for (int i = 0; i < N; i++) {
            ...
            if (pMP) {
                ...
                // SLAM with respect a rigid body
                    ...
                    cv::KeyPoint kpUn; // keypointUndistort
...
int Optimizer::PoseOptimizationDeep(Frame* pFrame)
{
    g2o::SparseOptimizer optimizer;
    g2o::BlockSolver_6_3::LinearSolverType* linearSolver;
...

    {
        ...
        // cout << "pFrame->mvKeys.size() = " << pFrame->mvKeys.size() << endl;
        // cout << "pFrame->mvKeysUn.size() = " << pFrame->mvKeysUn.size() << endl;
        // cout << "pFrame->mvConf.size() = " << pFrame->mvConf.size() << endl;
        for (int i = 0; i < N; i++) {
            MapPoint* pMP = pFrame->mvpMapPoints[i];
            if (pMP) {
                // Conventional SLAM
...
int Optimizer::PoseInertialOptimizationDeepLastKeyFrame(Frame* pFrame, bool bRecInit)
{
    g2o::SparseOptimizer optimizer;
    g2o::BlockSolverX::LinearSolverType* linearSolver;
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (pMP) {
                ...
                // Stereo observation
                    ...
                    // Add here uncerteinty
                    const float unc2 = pFrame->mpCamera->uncertainty2(obs.head(2)); // return 1.0
...
int Optimizer::PoseInertialOptimizationDeepLastFrame(Frame* pFrame, bool bRecInit)
{
    g2o::SparseOptimizer optimizer;
    g2o::BlockSolverX::LinearSolverType* linearSolver;
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (pMP) {
                ...
                if (bRight && i >= Nleft) {
                    ...
                    const float invSigma2 = pFrame->mvInvLevelSigma2[kpUn.octave] / unc2;
                    e->setInformation(Eigen::Matrix2d::Identity() * invSigma2); // TODO: 右目暂无置信图信息
